...
const line = '<svg viewBox="0 0 76 12"> <path class="line" d="M70,12H6c-3.3,0-6-2.7-6-6v0c0-3.3,2.7-6,6-6h64c3.3,0,6,2.7,6,6v0C76,9.3,73.3,12,70,12z"/> </svg>';
...
class Particle {
  ...
  move() {
    ...
    this.item.css({
      transform: "translateX(" + (-60 + x) + "px) translateY(" + y + "px) scale(" + this.scale + ") rotate(" + this.rotation + x + "deg)" });
...
const data = [line, point, rhombus, pentahedron, circle, x];
